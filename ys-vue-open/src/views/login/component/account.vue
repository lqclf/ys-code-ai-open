<template>
	<el-form size="large" class="login-content-form">
		<el-form-item class="login-animation1">
			<el-input text :placeholder="$t('message.account.accountPlaceholder1')" v-model="state.ruleForm.loginName" clearable autocomplete="off">
				<template #prefix>
...
const onSignIn = async () => {
	...
	if(res.code === 200) {
		...
		Reflect.set(userInfos, "btnRoles", userInfos.permissions);
		Reflect.set(userInfos, "time", new Date().getTime());
		//登陆成功，存储token
		// 存储 token 到浏览器缓存
